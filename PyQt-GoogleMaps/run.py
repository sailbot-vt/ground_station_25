...
class MainWindow(QMainWindow):
    ...
    def layout(self):
        ...
        self.markersProgressBar.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
    ...
    def getMapMarkers(self):
        ...
        # Use runJavaScript for QWebEngine, handle result asynchronously
        self.map.page().runJavaScript("GetMarkers()", lambda x: print(x))

    def handleMarkersResult(self, markers):
        print(markers)
